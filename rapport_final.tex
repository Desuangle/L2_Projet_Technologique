...
Nous avons avec net_text impl\'ement\'e une version textuelle du jeu net via le terminal en demandant
seulement les coordonn\'ees de la pi\`ece \`a tourner \`a l'utilisateur.

\subsection{Analyse}

La premi\`ere impl\'ementation de net_text employait un switch case pour associer chaque couple 
